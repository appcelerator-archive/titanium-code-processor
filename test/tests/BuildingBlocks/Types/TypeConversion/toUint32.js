...
module.exports = [{
		...
		testFunction: function() {
			numResult.value = 0;
			return Types.toUint32(new Types.TypeUndefined());
		},
		props: {
		...
		testFunction: function() {
			numResult.value = 0;
			return Types.toUint32(new Types.TypeNull());
		},
		props: {
			expectedReturnValue: numResult
		}
