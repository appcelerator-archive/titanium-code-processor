...
module.exports = [{
		...
		testFunction: function() {
			numResult.value = 0;
			return Types.toInteger(new Types.TypeUndefined());
		},
		props: {
		...
		testFunction: function() {
			numResult.value = 0;
			return Types.toInteger(new Types.TypeNull());
		},
		props: {
			expectedReturnValue: numResult
		}
		...
		testFunction: function() {
			...
			numResult.value = 0xFFFFFFFFFFFF;
			return Types.toInteger(num);
		},
		props: {
			expectedReturnValue: numResult
