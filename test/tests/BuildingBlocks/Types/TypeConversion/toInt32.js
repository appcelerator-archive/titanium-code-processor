...
module.exports = [{
		...
		testFunction: function() {
			numResult.value = 0;
			return Types.toInt32(new Types.TypeUndefined());
		},
		props: {
		...
		testFunction: function() {
			numResult.value = 0;
			return Types.toInt32(new Types.TypeNull());
		},
		props: {
			expectedReturnValue: numResult
		}
