...
/**
 * A VM object representation of a native error thrown from {@link module:Base.throwNativeException}
 * 
 * @type module:Base.ObjectType
 */
exports.nativeException = undefined;

/**
 * A semaphore indicating whether or not the current code is ambiguous
 * 
 * @type Number
 * @name module:Runtime.ambiguousCode
 */
Object.defineProperty(exports, 'ambiguousCode', {
	configurable: false,
	enumerable: true,
	set: function(value) {
		if (!exports.options.exactMode) {
			ambiguousCode = value;
		}
	},
	get: function() {
