 ...
 * @returns {module:Runtime.location} The current location
 */
 ...
 * @returns {module:Runtime.location} The mapped location, if it can be mapped, else the original location
 */
 ...
 * @param {Array.<Base.BaseType>} args The function arguments
 ...
 * @returns {Array.<module:Runtime.eventObject>} The list of errors
 */
 ...
 * @returns {Array.<module:Runtime.eventObject>} The list of warnings
 */
