...
/**
 * Gets the module execution context (what is normally viewed as "global" in most cases, equivalent to module scope in node.js)
 * 
 * @method
 * @returns {Base.ExecutionContext} The global execution context
 */
...
function setCurrentFile(file) {
	log('trace', 'Entering new file ' + file);
	fileStack.push(file);
}
...
function popCurrentFile() {
	log('trace', 'Exiting file ' + getCurrentFile());
