...
/**
 * A semaphore indicating whether or not the current block is ambiguous
 * 
 * @type Number
 * @name module:Runtime.ambiguousBlock
 */
Object.defineProperty(exports, 'ambiguousBlock', {
	configurable: false,
	enumerable: true,
	set: function(value) {
		if (!exports.options.exactMode) {
			ambiguousBlock = value;
		}
	},
	get: function() {
