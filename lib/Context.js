 ...
 * 
 * @method
 * @param {module:AST.node} code The code associated with this global context
 * @returns {module:Base.ExecutionContext} The new global execution context
 * @see ECMA-262 Spec Chapter 10.4.1 and Chapter 10.5
 */
exports.createGlobalContext = function createGlobalContext(code, strict) {
	...
	var globalObject = new Base.ObjectType(),
		...
		len, i,
		functions = findFunctionDeclarations(code),
		variables = findVariableDeclarations(code);
