 ...
 * @property {module:Base.BaseType} initialExpression The result of evaluating the first expression in a for loop run 
 *		before the loop is evaluated. Only available post-evaluation.
