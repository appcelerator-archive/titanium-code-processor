 ...
 * @property {module:Context.FunctionType} result The created function object. Only available post-evaluation.
 */
...
exports.processRule = function processRule(ast) {
	...
	if (identifier) {
		funcEnv = new Context.NewDeclarativeEnvironment(context.lexicalEnvironment);
		funcEnv.envRec.createImmutableBinding(identifier);
		functionObject = new Context.FunctionType(formalParameterList, functionBody, funcEnv, strict);
