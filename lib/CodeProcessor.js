 ...
 *
 * @event module:CodeProcessor.enteredFile
 ...
 *
 * @event module:CodeProcessor.projectProcessingBegin
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
 ...
 *
 * @event module:CodeProcessor.projectProcessingEnd
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
 ...
 *
 * @event module:CodeProcessor.undeclaredGlobalVariableCreated
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
...
/**
 * The maximum recursion, as specified by the maxRecursionLimit property of {@link module:Runtime.options}, was reached
 *
 * @event module:CodeProcessor.maxRecusionLimitReached
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
...
/**
 * The maximum loop iteration limit, as specifiedby the maxLoopIterations of {@link module:Runtime.options}, was reached
 *
 * @event module:CodeProcessor.maxIterationsExceeded
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
 ...
 *
 * @event module:CodeProcessor.errorReported
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
 ...
 *
 * @event module:CodeProcessor.warningReported
 * @property {string} type The type of the event
 * @property {string} description The description of the event
 * @property {(string | undefined)} filename The name of the file being processed when the event was triggered, if any
 * @property {(number | undefined)} line The line number of the file being processed when the event was triggered, if any
 ...
 *
 * @method module:CodeProcessor.queryOptions
 ...
 *
 * @method module:CodeProcessor.run
 ...
 *
 * @method module:CodeProcessor.init
 * @param {module:CodeProcessor.sourceInformation} sourceInformation The source information for the project
 * @param {Object} options The options for the run. See {@link module:CodeProcessor.queryOptions} for more info
 * @param {Object} plugins The plugins to load. Each key is the name of the plugin, and the value is the plugin information
 * @param {module:CodeProcessor.pluginInformation} plugins.entry A plugin entry, whose name is "entry"
 ...
 *
 * @method module:CodeProcessor.finalize
 */
 ...
 * Processes the input options
 *
 * @method module:CodeProcessor.processEntryPoint
...
function processEntryPoint(entryPoint) {
	...
	try {
		...
		if (results && results[0] === 'throw') {
			Runtime.reportError('uncaughtException', Base.getExceptionMessage(results[1]._exception), results[1]._exception.stackTrace);
		}
	} catch (e) {
		if (e.isCodeProcessorException) {
			results = ['throw', Runtime._exception, undefined];
			Runtime.reportError('uncaughtException', Base.getExceptionMessage(Runtime._exception), Runtime._exception.stackTrace);
 ...
 *
 * @method module:CodeProcessor.processQueuedFunctions
 */
...
function processQueuedFunctions() {
	...
	while (queuedFunction = Runtime.getNextQueuedFunction()) {
		...
		try {
			...
			if (e.isCodeProcessorException) {
				Runtime.reportError('uncaughtException', Base.getExceptionMessage(Runtime._exception), RuleProcessor.getStackTrace());
				Runtime._exception = undefined;
			} else {
				throw e;
			}
 ...
 *
 * @method module:CodeProcessor.processUnvisitedCode
 */
 ...
 * @property {Array.<Object>} warnings The warnings found in the project
 ...
 *
 * @method module:CodeProcessor.getResults
 * @return {module:CodeProcessor.getResultsReturnValue} The results of the analysis
 */
 ...
 *
 * @method module:CodeProcessor.nChars
 ...
 *
 * @method module:CodeProcessor.arrayGen
...
/**
 * The object that plugins return for rendering
 *
