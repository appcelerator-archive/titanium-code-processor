...
function process(projectRoot, pluginList, options, completionCallback, errorCallback) {
...
function runUnitTest(files, pluginList, options, completionCallback, errorCallback) {
	try {
...
function processHelper(files, pluginList, options, completionCallback, errorCallback) {
	...
	processingLoop: for (i = 0, len = tags.length; i < len; i++) {
		...
		var env = Base.NewObjectEnvironment(Runtime.globalObject, undefined);
