...
function run(entryPoint, options, plugins, logger, callback) {
	...
	if (Runtime.options.resultsPath) {
		generateResultsPages(Runtime.options.resultsPath, Runtime.options.resultsTheme, function () {
...
function generateResultsPages(resultsDirectory, theme, callback) {
	...
	console.log('The theme is at ' + theme);
	if (!existsSync(theme)) {
