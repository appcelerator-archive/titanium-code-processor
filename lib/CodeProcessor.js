 ...
 *
 * @name CodeProcessor#parsingComplete
 * @event
 * @param {JSContext} context The current state of the parser.
 ...
 */
var CodeProcessor = exports.CodeProcessor = function(projectRoot) {
 ...
 */
CodeProcessor.prototype.parse = function(completionCallback, errorCallback) {
 ...
 */
CodeProcessor.prototype.addEventListener = function(eventName, callback, canMakeModifications) {
 ...
 */
CodeProcessor.prototype.lookupVariable = function(variableName) {
 ...
 * @throws {InvalidContext} Thrown when not called from within a rule event callback.
 */
CodeProcessor.prototype.replaceCurrentBranch = function(newBranch) {
