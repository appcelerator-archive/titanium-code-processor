 ...
 */
exports.NumberType = function NumberType(initialValue, className) {
 ...
 */
exports.BooleanType = function BooleanType(initialValue, className) {
 ...
 */
exports.StringType = function StringType(initialValue, className) {
 ...
 */
exports.strictEquals = function strictEquals(x, y) {
	var typeX = type(x),
		typeY = type(y);
...
var strictEquals = exports.strictEquals;
...
function ObjectProtoToStringFunc(className) {
	...
	this.put("length", new NumberType(0), false);
}
...
function ObjectProtoHasOwnPropertyFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
	this.put("length", new NumberType(1), false);
}
...
function FunctionProtoApplyFunc(className) {
	ObjectType.call(this, className || "Function");
	this.put("length", new NumberType(2), false);
}
...
FunctionProtoBindFunc.prototype.call = function call(thisVal, args) {
	...
	f.put("length", new NumberType(type(target) === "Function" ? Math.max(0, target.get("length").value - a.length) : 0));
