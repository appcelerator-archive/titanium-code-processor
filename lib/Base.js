...
exports.FunctionType = function FunctionType(formalParameterList, functionBody, lexicalEnvironemnt, strict, className) {
	...
	if (strict) {
		...
		// TODO: Add function prototype to f
	}
};
var FunctionType = exports.FunctionType;
util.inherits(exports.FunctionType, ObjectType);
 ...
 */
function ToStringFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
}
util.inherits(ToStringFunc, FunctionType);
ToStringFunc.prototype.call = function call(thisVal, args) {
...
ToStringFunc.prototype.construct = false;
 ...
 */
function ToLocaleStringFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
}
util.inherits(ToLocaleStringFunc, FunctionType);
ToLocaleStringFunc.prototype.call = function call(thisVal, args) {
...
ToLocaleStringFunc.prototype.construct = false;
 ...
 */
function ValueOfStringFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
}
util.inherits(ValueOfStringFunc, FunctionType);
ValueOfStringFunc.prototype.call = function call(thisVal, args) {
	return toObject(thisVal);
};
ValueOfStringFunc.prototype.construct = false;
 ...
 */
function HasOwnPropertyFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
}
util.inherits(HasOwnPropertyFunc, FunctionType);
HasOwnPropertyFunc.prototype.call = function call(thisVal, args) {
...
HasOwnPropertyFunc.prototype.construct = false;
 ...
 */
function IsPrototypeOfFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
}
util.inherits(IsPrototypeOfFunc, FunctionType);
IsPrototypeOfFunc.prototype.call = function call(thisVal, args) {
	var result = new BooleanType(),
		o,
		v = args[0];
	result.value = false;
...
IsPrototypeOfFunc.prototype.construct = false;
 ...
 */
function PropertyIsEnumerableFunc(className) {
	ObjectType.call(this, className || "Function", undefined, true);
}
util.inherits(PropertyIsEnumerableFunc, FunctionType);
PropertyIsEnumerableFunc.prototype.call = function call(thisVal, args) {
	var result = new BooleanType(),
		p = toString(args[0]),
		o = toObject(thisVal),
		desc = o.getOwnProperty(p.value);
...
PropertyIsEnumerableFunc.prototype.construct = false;
...
exports.ObjectPrototypeType = function ObjectPrototypeType(className) {
	...
	// toString method
	this.put("toString", new ToStringFunc(), false);
	this.put("toLocaleString", new ToLocaleStringFunc(), false);
	this.put("valueOfString", new ValueOfStringFunc(), false);
	this.put("hasOwnProperty", new HasOwnPropertyFunc(), false);
	this.put("isPrototypeOf", new IsPrototypeOfFunc(), false);
	this.put("propertyIsEnumerable", new PropertyIsEnumerableFunc(), false);
};
