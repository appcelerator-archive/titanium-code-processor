...
function NumberType(initialValue, className) {
	...
	this.objectPrototype = prototypes.Number;
...
function BooleanType(initialValue, className) {
	...
	this.objectPrototype = prototypes.Boolean;
...
function StringType(initialValue, className) {
	...
	this.objectPrototype = prototypes.String;
...
function ObjectType(className, value, dontCreatePrototype) {
	...
	if (!dontCreatePrototype) {
		this.objectPrototype = prototypes.Object;
	}
...
function ArrayType(className) {
	...
	this.objectPrototype = prototypes.Array;
...
function RegExpType(pattern, flags, className) {
	...
	this.objectPrototype = prototypes.RegExp;
...
function FunctionTypeBase(length, className) {
	...
	// Step 4
	this.objectPrototype = prototypes.Function;
