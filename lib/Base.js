...
function isPropertyReference(v) {
	return hasPrimitiveBase(v) || isType(getBase(v), ["Object", "Function", "Arguments", "Array", "RegExp"]);
}
...
StringProtoToStringFunc.prototype.call = function call(thisVal, args) {
	if (type(thisVal) !== "String" || (type(thisVal) === "Object" && typeof thisVal.value !== "string")) {
		throw new Exceptions.TypeError();
	}
...
RegExpProtoExecFunc.prototype.call = function call(thisVal, args) {
	...
	r.put("lastIndex", new NumberType(rValue.lastIndex), false, true);
	r.put("ignoreCase", new BooleanType(rValue.ignoreCase), false, true);
	r.put("global", new BooleanType(rValue.global), false, true);
	r.put("multiline", new BooleanType(rValue.multiline), false, true);
	r.put("source", new StringType(rValue.source), false, true);
