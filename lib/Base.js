 ...
 *
 * @constructor module:Base.UnknownType
 * @param {string} [className] The name of the class, such as 'String' or 'Object'
 ...
 *
 * @constructor module:Base.UndefinedType
 * @extends module:Base.BaseType
 * @param {string} [className] The name of the class, such as 'String' or 'Object'
 ...
 *
 * @constructor module:Base.NullType
 * @extends module:Base.BaseType
 * @param {string} [className] The name of the class, such as 'String' or 'Object'
 ...
 *
 * @constructor module:Base.BooleanType
 * @extends module:Base.BaseType
 ...
 *
 * @constructor module:Base.StringType
 * @extends module:Base.BaseType
 ...
 * assignment.
 *
 * @constructor module:Base.DataPropertyDescriptor
 ...
 * get and set methods.
 *
 * @constructor module:Base.AccessorPropertyDescriptor
 ...
 *
 * @method module:Base.isDataDescriptor
 ...
 *
 * @method module:Base.isAccessorDescriptor
 * @param {(module:Base.DataPropertyDescriptor | module:Base.AccessorPropertyDescriptor | Object)} desc The property descriptor to test
 ...
 *
 * @method module:Base.isGenericDescriptor
 * @param {(module:Base.DataPropertyDescriptor | module:Base.AccessorPropertyDescriptor | Object)} desc The property descriptor to test
 ...
 *
 * @constructor module:Base.ObjectType
 * @extends module:Base.BaseType
 * @param {string} className The name of the class, such as 'String' or 'Object'
 ...
 *
 * @event module:Base.ObjectType#propertyReferenced
 ...
 *
 * @method module:Base.ObjectType#get
 ...
 *
 * @method module:Base.ObjectType#getOwnProperty
 ...
 * if absent.</em>
 *
 * @method module:Base.ObjectType#getProperty
 * @param {string} p The name of the property descriptor to fetch
 * @param {boolean} alternate Whether or not to fetch the alternate values, or the base value
 ...
 *
 * @event module:Base.ObjectType#propertySet
 ...
 * handling.</em>
 *
 * @method module:Base.ObjectType#put
 ...
 *
 * @method module:Base.ObjectType#canPut
 ...
 *
 * @method module:Base.ObjectType#hasProperty
 ...
 *
 * @event module:Base.ObjectType#propertyDeleted
 ...
 *
 * @method module:Base.ObjectType#delete
 ...
 *
 * @method module:Base.ObjectType#defaultValue
 * @param {string} A hint for the default value, one of 'String' or 'Number.' Any other value is interpreted as 'String'
 * @returns {(module:Base.StringType | module:Base.NumberType | module:Base.UndefinedType)} The primitive default value
 ...
 *
 * @event module:Base.ObjectType#propertyDefined
 * @param {string} name The name of the property referenced
 */
/**
 ...
 *
 * @method module:Base.ObjectType#defineOwnProperty
 * @param {string} p The name of the parameter to delete
 ...
 *
 * @constructor module:Base.ArrayType
 ...
 * flag controls failure handling.</em>
 *
 * @method module:Base.ArrayType#defineOwnProperty
 * @param {string} p The name of the parameter to delete
 * @param {(module:Base.DataPropertyDescriptor | module:Base.AccessorPropertyDescriptor)} desc The descriptor for the property
 * @param {boolean} throwFlag Whether or not to throw an exception on error (related to strict mode)
 * @param {boolean} suppressEvent Suppresses the 'propertyDefined' event (used when setting prototypes)
 ...
 *
 * @constructor module:Base.RegExpType
 * @extends module:Base.ObjectType
 ...
 *
 * @constructor module:Base.FunctionTypeBase
 * @extends module:Base.ObjectType
 ...
 * ECMA-262 Spec: <em>Returns the value of the named property.</em>
 *
 * @method module:Base.FunctionTypeBase#get
 * @param {string} p The name of the property to fetch
 * @param {boolean} alternate Whether or not to fetch the alternate values, or the base value
 * @returns {module:Base.BaseType} The value of the property, or a new instance of {@link module:Base.UndefinedType} if
 ...
 *
 * @method module:Base.FunctionTypeBase#hasInstance
 ...
 *
 * @constructor module:Base.FunctionType
 ...
 * Calls the function
 *
 * @method module:Base.FunctionType#callFunction
 ...
 *
 * @method module:Base.FunctionType#construct
 * @param (Array.<module:Base.BaseType>} args The set of arguments passed in to the function call
 ...
 * reference.</em>
 *
 * @constructor module:Base.ReferenceType
 * @extends module:Base.BaseType
 ...
 *
 * @method module:Base.getBase
 * @param {module:Base.ReferenceType} v The reference to get the base of
 * @returns {module:Base.BaseType} The base value of the reference
 * @see ECMA-262 Spec Chapter 8.7
 */
 ...
 *
 * @method module:Base.getReferencedName
 ...
 *
 * @method module:Base.isStrictReference
 ...
 *
 * @method module:Base.hasPrimitiveBase
 ...
 * returns false.</em>
 *
 * @method module:Base.isPropertyReference
 * @param {module:Base.ReferenceType} v The reference to get the name of
 ...
 *
 * @method module:Base.isUnresolvableReference
 * @param {module:Base.ReferenceType} v The reference to get the name of
 ...
 *
 * @method module:Base.getValue
 * @param {module:Base.ReferenceType} v The reference to get
 * @returns {(module:Base.BaseType | module:Base.UndefinedType)} The value pointed to by the reference, or
 ...
 *
 * @constructor module:Base.NumberPrototypeType
 ...
 * @classdesc The prototype for Booleans
 *
 * @constructor module:Base.BooleanPrototypeType
 * @see ECMA-262 Spec Chapter 15.6.4
 */
 ...
 *
 * @constructor module:Base.StringPrototypeType
 ...
 *
 * @constructor module:Base.ObjectPrototypeType
 ...
 *
 * @constructor module:Base.ArrayPrototypeType
 ...
 *
 * @constructor module:Base.FunctionPrototypeType
 ...
 *
 * @method module:Base.FunctionPrototypeType#callFunction
 * @see ECMA-262 Spec Chapter 15.3.4
 */
 ...
 *
 * @constructor module:Base.ErrorPrototypeType
 ...
 * @classdesc The prototype for Errors
 *
 * @constructor module:Base.DatePrototypeType
 ...
 *
 * @method module:Base.toPrimitive
 ...
 *
 * @method module:Base.toBoolean
 * @param {module:Base.BaseType} input The value to convert
 * @return {module:Base.BooleanType} The converted value
 ...
 *
 * @method module:Base.toNumber
 * @param {module:Base.BaseType} input The value to convert
 * @return {module:Base.NumberType} The converted value
 ...
 *
 * @method module:Base.toString
 * @param {module:Base.BaseType} input The value to convert
 * @return {module:Base.StringType} The converted value
 ...
 *
 * @method module:Base.toObject
 * @param {module:Base.BaseType} input The value to convert
 * @return {module:Base.ObjectType} The converted value
 ...
 *
 * @method module:Base.fromPropertyDescriptor
 ...
 * @return {(module:Base.UndefinedType | module:Base.ObjectType)} The converted property descriptor
 ...
 *
 * @method module:Base.toPropertyDescriptor
 * @param {Object} o The object to convert
 * @return {(module:Base.DataPropertyDescriptor | module:Base.AccessorPropertyDescriptor)} The converted property descriptor
 ...
 *
 * @method module:Base.checkObjectCoercible
 ...
 *
 * @method module:Base.convertToUnknown
 ...
 *
 * @method module:Base.strictEquals
 ...
 *
 * @constructor module:Base.DeclarativeEnvironmentRecord
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#createMutableBinding
 * @param {string} n The name of the binding
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#setMutableBinding
 * @param {string} n The name of the binding
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#getBindingValue
 * @param {string} n The name of the binding
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#deleteBinding
 * @param {string} n The name of the binding
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#implicitThisValue
 * @return {module:Base.UndefinedType} Always undefined
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#createImmutableBinding
 * @param {string} n The name of the binding
 * @throws Thrown if the binding already exists
 ...
 *
 * @method module:Base.DeclarativeEnvironmentRecord#initializeImmutableBinding
 * @param {string} n The name of the binding
 ...
 *
 * @constructor module:Base.ObjectEnvironmentRecord
 ...
 *
 * @method module:Base.ObjectEnvironmentRecord#hasBinding
 * @param {string} n The name of the binding
 * @return {boolean} Whether or not this environment record has the binding
 ...
 * false.</em>
 *
 * @method module:Base.ObjectEnvironmentRecord#createMutableBinding
 * @param {string} n The name of the binding
 * @param {boolean} d Whether or not the binding can be deleted
 * @param {boolean} suppressEvent Suppresses the 'propertySet' event (used when setting prototypes)
 * @throws Thrown if the binding already exists
 ...
 *
 * @method module:Base.ObjectEnvironmentRecord#setMutableBinding
 * @param {string} n The name of the binding
 * @param {module:Base.BaseType} v The value to set on the binding
 * @param {boolean} s Indicates strict mode, i.e. whether or not an error should be thrown if the binding is not mutable
 * @param {boolean} suppressEvent Suppresses the 'propertySet' event (used when setting prototypes)
 ...
 * writable, error handling is determined by the value of the Boolean argument s.</em>
 *
 * @method module:Base.ObjectEnvironmentRecord#getBindingValue
 * @param {string} n The name of the binding
 * @param {boolean} s Indicates strict mode, i.e. whether or not an error should be thrown if the binding has not been
 *		initialized
 * @param {boolean} alternate Whether or not to get the alternate or standard value(s)
 ...
 * value true.</em>
 *
 * @method module:Base.ObjectEnvironmentRecord#deleteBinding
 * @param {string} n The name of the binding
 * @return {boolean} Whether or not the binding has been deleted
 ...
 * flag is true.</em>
 *
 * @method module:Base.ObjectEnvironmentRecord#implicitThisValue
 ...
 *
 * @constructor module:Base~LexicalEnvironment
 ...
 *
 * @method module:Base.getIdentifierReference
 ...
 *
 * @method module:Base.newDeclarativeEnvironment
 * @param {(module:Base.LexicalEnvironment | undefined)} e The outer lexical environment of the new lexical environment
 * @return {module:Base.LexicalEnvironment} The newly created lexical environment
 ...
 *
 * @method module:Base.newObjectEnvironment
 ...
 * associated code.</em>
 *
 * @constructor module:Base.ExecutionContext
 * @param {module:Base.LexicalEnvironment} lexicalEnvironment ECMA-262 Spec: <em>Identifies the Lexical Environment
 *		used to resolve identifier references made by code within this execution context.</em>
 * @param {module:Base.LexicalEnvironment} variableEnvironment ECMA-262 Spec: <em>Identifies the Lexical Environment
 ...
 * @param {module:Base.ObjectType} thisBinding ECMA-262 Spec: <em>The value associated with the this keyword within
 ...
 *
 * @method module:Base.createGlobalContext
 * @param {boolean} strict Indicates whether or not this execution context is strict mode
 * @return {module:Base.ExecutionContext} The new global execution context
 ...
 *
 * @method module:Base.initGlobalAST
 ...
 *
 * @method module:Base.createEvalContext
 ...
 * @return {module:Base.ExecutionContext} The new eval execution context
 ...
 * @return {module:Base.ObjectType} The global object
 */
 ...
 *
 * @method module:Base.enterAmbiguousBlock
 */
 ...
 *
 * @method module:Base.exitAmbiguousBlock
 */
 ...
 *
 * @method module:Base.isAmbiguousBlock
 */
 ...
 *
 * @method module:Base.processInSkippedMode
 ...
 *
 * @method module:Base.isSkippedMode
 ...
 *
 * @method module:Base.isLocalSkippedMode
 * @return {boolean} Whether or not we are in skipped mode
 */
 ...
 *
 * @method module:Base.getSkippedSection
 ...
 *
 * @method module:Base.enterTryCatch
 */
 ...
 *
 * @method module:Base.exitTryCatch
 */
 ...
 *
 * @method module:Base.getCurrentContext
 * @return {module:Base.ExecutionContext} The current execution context
 */
 ...
 *
 * @method module:Base.enterContext
 ...
 *
 * @method module:Base.exitContext
 */
 ...
 *
 * @method module:Base.inFunctionContext
 ...
 *
 * @method module:Base.getGlobalContext
 * @return {module:Base.ExecutionContext} The global execution context
 */
 ...
 *
 * @method module:Base.getModuleContext
 * @return {module:Base.ObjectType} The module object
 */
 ...
 *
 * @method module:Base.createArgumentsObject
 ...
 * @return {module:Base.ObjectType} The arguments object
 ...
 *
 * @method module:Base.createFunctionContext
 ...
 * the exception.
 *
 * @method module:Base.handleRecoverableNativeException
 ...
 *
 * @method module:Base.throwNativeException
 * @param {String} exceptionType The type of exception, e.g. 'TypeError'
 * @param {String} message The exception message
 */
 ...
 * the rule processing flow.
 *
 * @method module:Base.throwException
 * @param {String} exceptionType The type of exception, e.g. 'TypeError'
 * @param {String} message The exception message
 */
 ...
 *
 * @method module:Base.getExceptionMessage
