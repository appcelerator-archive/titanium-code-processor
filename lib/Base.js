 ...
 * @private
 */
ObjectType.prototype._lookupProperty = function (p) {
 ...
 * @private
 */
ObjectType.prototype._addProperty = function (p, desc) {
	desc._name = p;
 ...
 * @private
 */
ObjectType.prototype._removeProperty = function (p) {
	var i = 0, len = this._properties.length;
	for (; i < len; i++) {
		if (this._properties[i]._name === p) {
 ...
 * @private
 */
ObjectType.prototype._getPropertyNames = function (p) {
	var i = 0, len = this._properties.length,
		properties = [];
	for (; i < len; i++) {
		properties(this._properties[i]._name);
	}
	return properties;
};
...
util.inherits(ErrorPrototypeType, ObjectType);
