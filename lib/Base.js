...
function enterSkippedMode() {
	...
	if (!skippedModeCounter) {
		...
		prototypes.Object = clonedGlobalObject.get('Object');
		prototypes.Function = clonedGlobalObject.get('Function');
		prototypes.Number = clonedGlobalObject.get('Number');
		prototypes.Boolean = clonedGlobalObject.get('Boolean');
		prototypes.String = clonedGlobalObject.get('String');
		prototypes.Array = clonedGlobalObject.get('Array');
		prototypes.RegExp = clonedGlobalObject.get('RegExp');
		prototypes.Date = clonedGlobalObject.get('Date');
		prototypes.Error = clonedGlobalObject.get('Error');
		prototypes.EvalError = clonedGlobalObject.get('EvalError');
		prototypes.RangeError = clonedGlobalObject.get('RangeError');
		prototypes.ReferenceError = clonedGlobalObject.get('ReferenceError');
		prototypes.SyntaxError = clonedGlobalObject.get('SyntaxError');
		prototypes.TypeError = clonedGlobalObject.get('TypeError');
		prototypes.URIError = clonedGlobalObject.get('URIError');
	}
	skippedModeCounter++;
}
...
function exitSkippedMode() {
	...
	if (!skippedModeCounter) {
		...
		prototypes.Object = globalObject.get('Object');
		prototypes.Function = globalObject.get('Function');
		prototypes.Number = globalObject.get('Number');
		prototypes.Boolean = globalObject.get('Boolean');
		prototypes.String = globalObject.get('String');
		prototypes.Array = globalObject.get('Array');
		prototypes.RegExp = globalObject.get('RegExp');
		prototypes.Date = globalObject.get('Date');
		prototypes.Error = globalObject.get('Error');
		prototypes.EvalError = globalObject.get('EvalError');
		prototypes.RangeError = globalObject.get('RangeError');
		prototypes.ReferenceError = globalObject.get('ReferenceError');
		prototypes.SyntaxError = globalObject.get('SyntaxError');
		prototypes.TypeError = globalObject.get('TypeError');
		prototypes.URIError = globalObject.get('URIError');
	}
}
