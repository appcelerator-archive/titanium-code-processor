...
RegExpProtoExecFunc.prototype.call = function call(thisVal, args) {
	...
	r.put("lastIndex", new NumberType(rValue.lastIndex), false);
	r.put("ignoreCase", new BooleanType(rValue.ignoreCase), false);
	r.put("global", new BooleanType(rValue.global), false);
	r.put("multiline", new BooleanType(rValue.multiline), false);
	r.put("source", new StringType(rValue.source), false);
