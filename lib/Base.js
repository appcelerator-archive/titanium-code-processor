...
exports.ArrayType = function ArrayType(className) {
	...
	// TODO: create array prototype, etc
};
...
exports.FunctionType = function FunctionType(formalParameterList, functionBody, lexicalEnvironemnt, strict, className) {
	FunctionTypeBase.call(this, formalParameterList ? formalParameterList.length : 0, false, className || "Function");
...
exports.FunctionType.prototype.construct = function construct(args) {
	...
	if (type(proto) === "Object") {
		...
		// TODO: Standard function prototype
		throw new Error("IMPLEMENT ME");
	}
...
exports.createThrowTypeErrorFunction = function createThrowTypeErrorFunction() {
	...
	if (!throwTypeError) {
		var globalContext = Runtime.globalContext,
