 ...
 *
 * @method module:CodeProcessorUtils.pluralize
 ...
 *
 * @method module:CodeProcessorUtils.getSubDirectories
 ...
 *
 * @method module:CodeProcessorUtils.findJavaScriptFiles
 * @param {string} baseDir The path to the base directory to search
 ...
 * @return {boolean} Whether or not to include this file in the results
 */
/**
 ...
 * @return {boolean} Whether or not to recurse into this directory
 */
/**
 * Crawls a directory looking for files and folders and optionally call user-supplied callbacks when found
 *
 * @method module:CodeProcessorUtils.crawlDirectory
