...
/**
 * Gets the node type (e.g. 'AST_Toplevel') for a given node
 *
 * @method
 * @param {module:AST.node} ast The ast to check the type of
 * @returns {String|undefined} The type of the node, or undefined if not an AST node type
 */
exports.getNodeType = getNodeType;
function getNodeType (ast) {
	return 'AST_' + Object.getPrototypeOf(ast).TYPE;
}
