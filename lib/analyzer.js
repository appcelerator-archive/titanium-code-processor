 ...
 * @see CodeAnalyzer#addEventListener
 */
/**
 * Indicates that <code>require()</code> was called. 
 *
 * @name CodeAnalyzer#fileRequire
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 ...
 *
 * @name CodeAnalyzer#fileParsingBegin
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 ...
 *
 * @name CodeAnalyzer#fileParsingEnd
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 ...
 *
 * @name CodeAnalyzer#fileLoadError
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 ...
 *
 * @name CodeAnalyzer#contextChange
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 ...
 */
/**
 * Indicates that a parse error was encountered. Note: parse errors also invoke the {@link CodeAnalyzer#parse} method's
 * error callback with the information below.
 *
 * @name CodeAnalyzer#parseError
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 ...
 * {@link CodeAnalyzer#parse} method's completion callback with the information below.
 *
 * @name CodeAnalyzer#parsingComplete
 * @event
 * @param {JSContext} context The current state of the parser.
 ...
 * rule event.
 *
 * @name CodeAnalyzer#ruleEvent
 * @event
 * @param {JSContext} context The current state of the parser.
 * @param {Object} eventData The data for the event. 
 * @param {String} eventData.ruleName The name of the rule, as passed in to {@link CodeAnalyzer#addEventListener}.
 ...
 * @param {CodeAnalyzerEventCallback} callback The function to call when the event is fired.
