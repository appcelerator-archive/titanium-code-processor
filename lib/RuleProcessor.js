...
function processRule(ast) {
	...
	var result,
		...
		start = ast.start,
		filename = (start && start.file) || (currentLocation && currentLocation.filename) || '',
		line = (start && start.line) || (currentLocation && currentLocation.line) || 0,
		column = (start && start.col) || (currentLocation && currentLocation.column) || 0,
		i, len,
		breakpoint;
